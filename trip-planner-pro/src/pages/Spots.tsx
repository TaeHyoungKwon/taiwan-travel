...
import { spotsData, spotCategories, type SpotItem } from "@/data/spots";
import ItemCard from "@/components/ItemCard";
import ItemDetail from "@/components/ItemDetail";

const categoryLabels: Record<SpotItem["category"], string> = {
  landmark: "랜드마크",
  street_walk: "감성거리",
  culture_complex: "문화공간",
  day_trip: "근교투어",
};
...
const Spots = () => {
  ...
  const filtered =
    activeCategory === "all"
      ? spotsData
      : spotsData.filter((s) => s.category === activeCategory);
        ...
        {selectedItem ? (
          ...
          >
            ...
            <div className="mb-8 text-center">
              ...
              >
                Gemini + GPT가 추천하는 타이베이 명소 {spotsData.length}곳
              </motion.p>
            </div>
